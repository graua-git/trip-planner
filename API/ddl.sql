...
-- Tasks
INSERT INTO `Tasks` (`name`, `trip`, `assignee`, `created_by`, `date_created`, `due_date`)
VALUES ('Buy plane tickets', 1, 1, 1, '2023-07-25 17:13:24', '2023-07-31 17:13:24'),
        ...
        ('Pay John for BnB', 1, 2, 2, '2023-07-25 12:43:11', '2023-08-14 23:59:59'),
        ('Buy Concert Tickets', 2, 1, 1, '2021-04-24 11:13:54', null),
        ('Buy Amusement Park Tickets', 2, 3, 1, '2021-04-24 11:14:34', null),
        ('Reserve Hotel', 3, 4, 3, '2022-05-12 09:32:01', '2022-05-19 23:59:59'),
        ('Buy Equipment', 3, 4, 4, '2022-05-12 09:33:49', '2022-05-19 23:59:59');

-- Expenses
INSERT INTO `Expenses` (`name`, `trip`, `owed_to`, `owed_by`, `date_created`, `amount`, `settled`)
...
-- Events
INSERT INTO `Events` (`name`, `trip`, `created_by`, `from_date`, `to_date`)
